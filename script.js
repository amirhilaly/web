...
$(document).ready(function () {
    ...
    $('#load-movies-btn').click(function () {
        ...
        let url = `https://backendmovies-ixgxb8mkr-amirhilalys-projects.vercel.app/api/movies?origine=${selectedCountry}&categorie=${selectedType}`;
    ...
    $(document).on("click", ".bomb", function () {
        ...
        fetch(`https://backendmovies-ixgxb8mkr-amirhilalys-projects.vercel.app/api/movies/${movieId}`, {
            method: "DELETE"
        })
    ...
    $('#edit-form').submit(function (event) {
        ...
        $.ajax({
            url: `https://backendmovies-ixgxb8mkr-amirhilalys-projects.vercel.app/api/movies/${movieId}`,
            type: 'PUT',
    ...
    $('#add-movie').submit(function (event) {
        ...
        $.ajax({
            url: 'https://backendmovies-ixgxb8mkr-amirhilalys-projects.vercel.app/api/movies',
            type: 'POST',
            contentType: 'application/json',
            data: JSON.stringify(formData),
            success: function (response) {
