...
$(document).ready(function () {
    ...
    $('#load-movies-btn').click(function () {
        ...
        let url = `https://backendmovies-pgzahd8ib-amirhilalys-projects.vercel.app/api/movies?origine=${selectedCountry}&categorie=${selectedType}`;
    ...
    $(document).on("click", ".bomb", function () {
        ...
        fetch(`https://backendmovies-pgzahd8ib-amirhilalys-projects.vercel.app/api/movies/${movieId}`, {
            method: "DELETE"
        })
    ...
    $('#edit-form').submit(function (event) {
        ...
        $.ajax({
            url: `https://backendmovies-pgzahd8ib-amirhilalys-projects.vercel.app/api/movies/${movieId}`,
            type: 'PUT',
    ...
    $('#add-movie').submit(function (event) {
        ...
        $.ajax({
            url: 'https://backendmovies-pgzahd8ib-amirhilalys-projects.vercel.app/api/movies',
            type: 'POST',
            contentType: 'application/json',
            data: JSON.stringify(formData),
            success: function (response) {
